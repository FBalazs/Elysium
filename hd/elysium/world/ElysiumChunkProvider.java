...
public class ElysiumChunkProvider implements IChunkProvider
{
	/** RNG. */
	private Random rand;
	...
	public ElysiumChunkProvider(World world, long seed, boolean features)
	{
		this.worldObj = world;
	 ...
	 */
	public void replaceBlocksForBiome(int par1, int par2, byte[] blocks, BiomeGenBase[] biomeArray)
	{
