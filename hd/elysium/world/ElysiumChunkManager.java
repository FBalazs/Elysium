...
public class ElysiumChunkManager extends WorldChunkManager
{
	public BiomeGenBase[] elysiumBiomes = new BiomeGenBase[]
	{
		Elysium.biomeOcean,
		Elysium.biomePlain,
		Elysium.biomeHills,
	...
	public ElysiumChunkManager(long seed, WorldType worldType)
	{
		this();
	...
	public ElysiumChunkManager(World world)
	{
	...
	public float[] getRainfall(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
	{
		...
		{
			float f = (float)this.elysiumBiomes[aint[i1]%this.elysiumBiomes.length].getIntRainfall() / 65536.0F;
	...
	public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
	{
		...
		for(int i1 = 0; i1 < par4 * par5; ++i1)
		{
			float f = (float)this.elysiumBiomes[aint[i1]%this.elysiumBiomes.length].getIntTemperature() / 65536.0F;
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5)
	{
		...
		for(int i1 = 0; i1 < par4 * par5; ++i1)
		{
			par1ArrayOfBiomeGenBase[i1] = this.elysiumBiomes[aint[i1]%this.elysiumBiomes.length];
		}
	...
	public boolean areBiomesViable(int par1, int par2, int par3, List par4List)
	{
		...
		{
			BiomeGenBase biomegenbase = this.elysiumBiomes[aint[j2]%this.elysiumBiomes.length];
	...
	public ChunkPosition findBiomePosition(int par1, int par2, int par3, List par4List, Random par5Random)
	{
		...
		for(int k2 = 0; k2 < l1 * i2; ++k2)
		{
			int l2 = l + k2 % l1 << 2;
			int i3 = i1 + k2 / l1 << 2;
			BiomeGenBase biomegenbase = this.elysiumBiomes[aint[k2]%this.elysiumBiomes.length];
